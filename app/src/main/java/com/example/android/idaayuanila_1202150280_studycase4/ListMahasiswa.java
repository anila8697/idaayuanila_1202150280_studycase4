...
public class ListMahasiswa extends AppCompatActivity {
    ...
    private String[] mahasiswa = {"Anila", "Sukma", "Murti", "Ida", "Ayu", "Gede", "Dayu", "Anil"};
    ...
    public class ItemList extends AsyncTask<Void, String, Void> {
        ...
        protected void onPreExecute() {
            ...
            mDialog.setTitle("Please wait, data still loading");//Komponen ini digunakan untuk mengatur judul dialog progress
